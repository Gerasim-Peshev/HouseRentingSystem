...
namespace HouseRentingSystem.Services.House
{
    public class HouseService : IHouseService
    {
        ...
        public HouseQueryServiceModel All(string category = null, string searchTerm = null, HouseSorting sorting = HouseSorting.Newest,
        ...
        public async Task<IEnumerable<string>> AllCategiriesNames()
        {
            return await context
                        .Categories
                        .Select(c => c.Name)
        ...
        {
            var house = await context.Houses.FirstOrDefaultAsync(h => h.Id == houseId);
            var agemt = await context.Agents.FirstOrDefaultAsync(a => a.Id == house.AgentId);
